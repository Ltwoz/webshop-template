            ...
            <main className="max-w-[1150px] px-4 sm:px-[25px] pb-4 sm:pb-[25px] pt-24 md:pt-28 mx-auto items-center">
                ...
                <section className="bg-white border rounded-md shadow mb-6 divide-y">
                    <div className="p-6 flex items-center justify-between max-h-[88px]">
                        <h2 className="text-lg font-semibold">ประเภท Stock</h2>
                        <input
                            type="text"
                            name="website-title"
                            id="website-title"
                        ...
                        <table className="w-full table-fixed">
                            <thead>
                                <tr className="bg-gray-200 text-gray-600 text-sm leading-normal">
                                    <th className="py-3 px-6 text-left w-44 md:w-96">
                                        ชื่อสินค้า
                                    </th>
                                    ...
                                    <th className="py-3 px-6 text-center w-52">
                                        วันที่
                                    </th>
                                </tr>
                            </thead>
                                        ...
                                        <td className="py-3 px-6 text-left">
                                            <span
                                                className={
                                                    ...
                                                    (queue.status === "กำลังดำเนินการ"
                                                        ? " bg-orange-900 text-orange-300"
                                                        : queue.status === "สำเร็จ" ? " bg-green-900 text-green-300"
                                                        : queue.status === "ไม่สำเร็จ" ? " bg-red-900 text-red-300"
                                                        : queue.status === "ยกเลิก" ? " bg-red-900 text-red-300"
                                                        : "")
                                                }
                                            >
                                                {queue.status}
